...
def privacy():
    html = (
        '<!DOCTYPE html><html lang="ru"><head>'
        '<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
        '<title>Политика обработки персональных данных — A/B Testing Pro</title>'
        '<style>'
        'body{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;'
        'background:#f8f9fa;color:#1a1a2e;line-height:1.7}'
        '.wrap{max-width:800px;margin:0 auto;padding:2rem 1rem}'
        'h1{font-size:1.8rem;font-weight:700;margin-bottom:.5rem;color:#1a1a2e}'
        'h2{font-size:1.15rem;font-weight:700;margin:2rem 0 .75rem;color:#333}'
        'p,li{font-size:.95rem;color:#444;margin-bottom:.6rem}'
        'ul{padding-left:1.5rem;margin-bottom:1rem}'
        '.meta{font-size:.85rem;color:#888;margin-bottom:2rem}'
        ...
        '<h2>1. Общие положения</h2>'
        '<p>Настоящая Политика обработки персональных данных (далее — Политика) составлена '
        ...
        'пользователей сервиса A/B Testing Pro.</p>'
        '<p>Оператор персональных данных: ИП Клюева Наталья Анатольевна, '
        'ОГРНИП 322527500044708, ИНН 360402011440.</p>'

        '<h2>2. Какие данные мы собираем</h2>'
        '<ul>'
        '<li><strong>Имя и фамилия</strong> — указываются при регистрации</li>'
        '<li><strong>Адрес электронной почты</strong> — используется для входа и уведомлений</li>'
        '<li><strong>API-ключи маркетплейсов</strong> — для подключения магазина (хранятся в зашифрованном виде)</li>'
        '<li><strong>Данные об использовании сервиса</strong> — история тестов, статистика</li>'
        '<li><strong>Технические данные</strong> — IP-адрес, браузер, дата и время визитов</li>'
        '</ul>'
        ...
        '<p>Мы не продаём и не передаём ваши персональные данные третьим лицам, '
        'за исключением следующих случаев:</p>'
        '<ul>'
        '<li><strong>ЮКасса (АО «Национальные Кредитные Карточки»)</strong> — '
        'для обработки платежей. Передаются только данные, необходимые для проведения оплаты</li>'
        '<li><strong>По требованию закона</strong> — при наличии обязательного запроса '
        'от уполномоченных органов государственной власти РФ</li>'
        '</ul>'

        '<h2>6. Хранение и защита данных</h2>'
        '<ul>'
        '<li>Данные хранятся на серверах в защищённой среде</li>'
        ...
        '<li>Срок хранения данных — в течение действия аккаунта и 3 года после его удаления '
        '(в части финансовых документов — 5 лет согласно требованиям законодательства)</li>'
        '</ul>'
        ...
        '</ul>'
        '<p>Для реализации прав направьте запрос на email: '
        '<a href="mailto:attilainfo@yandex.ru" style="color:#667eea">attilainfo@yandex.ru</a></p>'

        '<h2>8. Cookies и аналитика</h2>'
        '<p>Сайт использует cookies только для хранения сессии авторизованного пользователя. '
        'Сторонние аналитические сервисы не используются. '
        'Вы можете отключить cookies в настройках браузера, однако это может нарушить '
        'работу авторизации.</p>'
        ...
        '<p>ИП Клюева Наталья Анатольевна<br>'
        'ИНН: 360402011440, ОГРНИП: 322527500044708<br>'
        'Email: <a href="mailto:attilainfo@yandex.ru" style="color:#667eea">attilainfo@yandex.ru</a><br>'
        'Телефон: +7 986 755-48-93</p>'

        '<p style="font-size:.82rem;color:#aaa;margin-top:2rem">'
        '<a href="/terms" style="color:#667eea">Публичная оферта</a>'
        ' &nbsp;·&nbsp; <a href="/contacts" style="color:#667eea">Контакты</a>'
        ' &nbsp;·&nbsp; &#169; 2025 A/B Testing Pro</p>'
        '</div></body></html>'
    )
    return html
